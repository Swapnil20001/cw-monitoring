            ...
            for metric, validation_alarm_configurations in alarms.items():
                ...
                for alarm_configuration in validation_alarm_configurations:
                    ...
                    for alarm in response['MetricAlarms']:
                        ...
                        mismatch_reasons = []
                        if (
                            alarm['Threshold'] != alarm_configuration['Threshold'] if metric_name not in ['RequestCount'] else False or
                            ...
                            if alarm['Threshold'] != alarm_configuration['Threshold'] if metric_name not in ['RequestCount'] else False:
